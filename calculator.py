...
# define entry
entry = Entry(root, width=20, font='Arial 20', bd=0)
...
def square():
    ...
    entry.delete(0, END)
    if not "." in first_num:
        entry.insert(0, int(first_num)*int(first_num))
    elif "." in first_num:
...
def sqrt():
    ...
    entry.delete(0, END)
    if not "." in first_num:
        entry.insert(0, math.sqrt(int(first_num)))
    elif "." in first_num:
        entry.insert(0, math.sqrt(float(first_num)))
...
button_0 = Button(root, text="0", padx=67, pady=20, bd=1, command=lambda: num(0))
button_clear = Button(root, text="C", padx=29, pady=20, bd=1, command=clear)
button_square = Button(root, text="x^2", padx=23, pady=20, bd=1, command=square)
button_sqrt = Button(root, text="sqrt", padx=23, pady=20, bd=1, command=sqrt)
...
button_add = Button(root, text="+", padx=29, pady=20, bd=1, command=add)
button_equals = Button(root, text="=", padx=29, pady=20, bd=1, command=equals)
